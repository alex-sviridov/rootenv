...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "id": "pbc_4287217533",
      "indexes": [],
      "listRule": "@request.auth.id = user.id || @request.auth.svc_role = 'relay' || @request.auth.svc_role = 'contmgr'",
      "name": "attempts",
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.id = user.id",
      "viewRule": "@request.auth.id = user.id || @request.auth.svc_role = 'relay' || @request.auth.svc_role = 'contmgr'"
    },
    {
      "createRule": null,
      "deleteRule": null,
      ...
      "id": "pbc_3738798621",
      "indexes": [],
      "listRule": "@request.auth.id = attempt.user.id || @request.auth.svc_role = \"contmgr\"",
      "name": "assets",
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.svc_role = \"contmgr\"",
      "viewRule": "@request.auth.id = attempt.user.id || @request.auth.svc_role = \"relay\" || @request.auth.svc_role = \"contmgr\""
    },
    {
    ...
    {
      "createRule": "@request.auth.svc_role = \"contmgr\"",
      "deleteRule": null,
      "fields": [
        {
          "autogeneratePattern": "[a-z0-9]{15}",
